...
import LogoImage from "../../assets/homepage/header/logo.svg";
    ...
    >
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form className="d-flex inputSearchForm" style={{ flexGrow: 1, justifyContent: "flex-end" }}>
            <div className="row" style={{width:"100%"}}>
              <div className="col-lg-8 col-md-7 col-sm-12" style={{display:"flex", justifyContent:"end"}}>
                <input
              ...
              <div className="col-lg-4 col-md-5 col-sm-12" style={{display:"flex", justifyContent:"start"}}>
                {loggedInStatus === false ? (
                  ...
                  <ul className="navbar-nav" style={{ fontSize: "1rem", gap: "5rem", marginRight: "50px" }}>
                    <li className="nav-item dropdown">
